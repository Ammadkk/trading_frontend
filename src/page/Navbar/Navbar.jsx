  ...
  return (
    <div className='px-2 py-3 border-b z-50 bg-background bg-opacity-0 sticky top-0 left-0 right-0 flex justify-between items-center'>
      <div className='flex items-center gap-3'>
        ...
        <p className="text-sm lg:text-base cursor-pointer font-semibold">
          Zen Trade
        </p>
...
{/*  */}
      ...
      <div>
        <Avatar className="h-8 w-8 rounded-full flex items-center justify-center">
          <AvatarFallback className="text-white bg-orange-600 h-full w-full rounded-full flex items-center justify-center">
